...
class UserRakeTest < ActiveSupport::TestCase
  ...
  setup do
    ...
    if (!@@rake)
      ...
      Rake.application.rake_require "../../lib/tasks/bonnie_users"
  ...
  test "approve rake task approves user" do
    ...
    capture_stdout do
      @@rake["bonnie:users:approve"].invoke
    end
  ...
  test "admin rake task approves and grants admin using email" do
    ...
    capture_stdout do
      @@rake["bonnie:users:grant_admin"].invoke
    end
  ...
  test "revoke rake task makes a admin user a non-admin" do
    ...
    capture_stdout do
      @@rake["bonnie:users:revoke_admin"].invoke
    end
