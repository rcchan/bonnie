...
class ExporterTest < ActiveSupport::TestCase
  ...
  test "test measure codes" do
    ...
    measure_codes.length.must_equal 5
    measure_codes.keys.must_equal ["2.16.840.1.113883.3.464.0001.231","2.16.840.1.113883.3.464.0001.250", "2.16.840.1.113883.3.464.0001.369","2.16.840.1.113883.3.464.0001.373","2.16.840.1.113883.3.560.100.4"]
