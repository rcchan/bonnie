...
gem 'hqmf2js', :git => 'https://github.com/pophealth/hqmf2js.git', :branch => 'initial_js'
#gem 'hqmf2js', path: '../hqmf2js'
gem 'hquery-patient-api', :git => 'https://github.com/hquery/patientapi.git', :branch => 'master'
